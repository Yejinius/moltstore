          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="space-y-2">
                <label className="flex items-center p-3 bg-gray-900 border border-gray-700 rounded-lg cursor-pointer hover:border-gray-600 transition">
                  <input
                    type="radio"
                    name="role"
                    value="user"
                    ...
                    className="h-4 w-4 text-orange-500 focus:ring-orange-500 bg-gray-800 border-gray-600"
                  />
                  <div className="ml-3">
